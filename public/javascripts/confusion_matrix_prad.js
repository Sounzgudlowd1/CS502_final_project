(function(){
	...
	function tabulate(data, columns) {
	    var table = d3.select("#dataView_prad").append("table")
	...
	d3.csv("viz_data/rna_predictions_PRAD.csv", function(error, data) {
	  var t_pos=0;
	  var t_neg=0;
	  var f_pos=0;
	  var f_neg=0;
	  data.forEach(function(d) {
	    // console.log(+d.predicted);
	  ...
	  Matrix({
	    container : '#confusion_matrix_prad',
